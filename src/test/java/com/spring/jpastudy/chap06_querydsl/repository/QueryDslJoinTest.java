...
import static com.spring.jpastudy.chap06_querydsl.entity.Album.*;
...
class QueryDslJoinTest {
    ...
    void iveTest() {
        //given
        List<Tuple> list = factory.select(idol.idolName, idol.group.groupName)
                .from(idol)
                .innerJoin(idol.group, group)
    ...
    void ageTest() {
        //given
        List<Tuple> list = factory.select(group.groupName, idol.age.avg())
                .from(group)
    ...
    void albumTest2022() {
        //given
        List<Tuple> list = factory.select(idol.idolName, idol.group.groupName, album.albumName, album.releaseYear)
                .from(album)
